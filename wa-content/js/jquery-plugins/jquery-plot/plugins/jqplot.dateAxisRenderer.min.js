...
(function($) {
    ...
    $.jqplot.DateAxisRenderer.prototype.createTicks = function(plot) {
        function dateSum( v1, value, unit ) {
            switch (unit.toLowerCase().replace(/s$/,"")) {
                case "millisecond":
                    v1.setMilliseconds(v1.getMilliseconds()+value);
                    break;
                case "second":
                    v1.setSeconds(v1.getSeconds()+value);
                    break;
                case "minute":
                    v1.setMinutes(v1.getMinutes()+value);
                    break;
                case "hour":
                    v1.setHours(v1.getHours()+value);
                    break;
                case "day":
                    v1.setDate(v1.getDate()+value);
                    break;
                case "week":
                    v1.setDate(v1.getDate()+(value*7));
                    break;
                case "month":
                    v1.setMonth(v1.getMonth()+value);
                    break;
                case "year":
                    v1.setFullYear(v1.getFullYear()+value);
                    break;
                default:
                    alert("Invalid unit: "+unit);
                    break;
            }
            return v1;
        }
        ...
        // if user specified min and max are null, we set those to make best ticks.
            ...
            if (titarget <= 19*day) {
                ...
                for (var i=0; i<nttarget; i++) {
                    ...
                    opts.value = dateSum(new $.jsDate(min), i*tempti, 'millisecond').getTime();
        ...
        ////////
            ...
            if (this.numberTicks == null){
                ...
                if (this.daTickInterval != null) {
                    ...
                    this.max = dateSum(new $.jsDate(this.min), (this.numberTicks-1) * this.daTickInterval[0], this.daTickInterval[1]).getTime();
                }
                else if (dim > 200) {
            ...
            for (var i=0; i<this.numberTicks; i++){
                ...
                tt = dateSum(min, i*this.daTickInterval[0], this.daTickInterval[1]).getTime();
                var t = new this.tickRenderer(this.tickOptions);
